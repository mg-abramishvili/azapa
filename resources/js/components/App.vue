<template>
    <nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
        <a class="navbar-brand me-lg-5" href="/">
            <img class="navbar-brand-dark" src="/img/brand/light.svg" alt="Azapa" /> <img class="navbar-brand-light" src="/img/brand/dark.svg" alt="Azapa" />
        </a>
    ...
    <nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
        ...
        <div class="d-flex align-items-center">
            <div class="avatar-lg me-4">
                <img src="/img/team/profile-picture-3.jpg" class="card-img-top rounded-circle border-white" alt="Имя Фамилия">
            </div>
            <div class="d-block">
                <h2 class="h5 mb-3">Привет!</h2>
        ...
        <svg class="icon icon-xs" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
            ...
            <ul class="nav flex-column pt-3 pt-md-0">
                <li class="nav-item">
                    ...
                    <span class="mt-1 ms-1 sidebar-text fw-bold">AZAPA</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <router-link :to="{name: 'Shops'}" class="nav-link">
                        ...
                        <span class="sidebar-text">Магазины</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link :to="{name: 'Pricelists'}" class="nav-link">
                        <span class="sidebar-icon">
                        ...
                        <span class="sidebar-text">Прайс-листы</span>
                    </router-link>
                </li>
                <li class="nav-item">
                    <router-link :to="{name: 'Shops'}" class="nav-link">
    ...
    <main class="content">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="input-group input-group-merge search-bar">
                ...
                <input type="text" class="form-control" id="topbarInputIconLeft" placeholder="Поиск" aria-label="Search" aria-describedby="topbar-addon">
            </div>
            </form>
            <!-- / Search form -->
        </div>
...
<footer class="bg-white rounded shadow p-4 mb-4 mt-4">
    <div class="row">
        <div class="col-12 col-md-4 col-xl-6 mb-4 mb-md-0">
            <p class="mb-0 text-center text-lg-start">© 2022 Azapa</p>
        </div>
