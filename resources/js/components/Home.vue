                    ...
                    <div class="card bg-yellow-100 border-0 shadow">
                        <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                            <div class="d-block mb-3 mb-sm-0">
                                <div class="fs-5 fw-normal mb-2">Продажи</div>
                                <h2 class="fs-3 fw-extrabold">186 321 руб.</h2>
                            </div>
                            <div class="d-flex ms-auto">
                                <a href="#" class="btn btn-secondary text-dark btn-sm me-2">День</a>
                                <a href="#" class="btn btn-dark btn-sm">Неделя</a>
                                <a href="#" class="btn btn-dark btn-sm">Месяц</a>
                            </div>
                        </div>
